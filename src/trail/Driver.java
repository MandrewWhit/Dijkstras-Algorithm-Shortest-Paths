...
public class Driver {
    ...
    private static ArrayList<RestStop> stops;
    ...
    public static void parseInputFile(String filename)
        ...
        for (int i = 0; i < numV; ++i) {
            ...
            RestStop currentRestStop = new RestStop(currNode);
            stops.add(currNode, currentRestStop);
        ...
        for (int i = 0; i < stops.size(); ++i) {
            RestStop currRestStop = stops.get(i);
            ArrayList<NeighborWeightTuple> neighbors = tempNeighbors.get(i);
            for (NeighborWeightTuple neighbor : neighbors) {
                testProgram2.setEdge(currRestStop, stops.get(neighbor.neighborID), neighbor.weight);
            }
        }

        testProgram2.setAllNodesArray(stops);
    }
    ...
    public static void testRun() {
        ...
        if (testDijkstra) {
            ...
            System.out.println("Length of shortest route from start to dest: \n" +
                    testProgram2.findMinimumRouteDistance(stops.get(4), stops.get(3)));
        }
        ...
        if (testMST) {
            ...
            System.out.println("\nGiven mountain: ");
            System.out.println(testProgram2);
            System.out.println("Minimum total pipe distance: \n" + testProgram2.findMinimumLength());
        }
    }
